...
namespace WebsiteBanHang.Controllers
{
    public class CategoryController : Controller
    {
        ...
        {
            var lstCategory = objwebbanhangonlineEntities.Categories.Where(n=>n.ShowOnHomePage==true).ToList();
        ...
        public ActionResult ProductCategory(int id, string currentFilter, int? page)
        {
            ...
            var lstProduct = objwebbanhangonlineEntities.Products.Where(n => n.CategoryId == id).ToList();
